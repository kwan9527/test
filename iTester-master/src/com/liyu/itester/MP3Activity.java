...
public class MP3Activity extends Activity
		implements OnClickListener, OnSeekBarChangeListener, MountListener.OnStateChangedListener {
	TextView tv_mp3;
	...
	public void onClick(View v) {
		...
		case R.id.button_pass:
			...
			if (FunctionApplication.isAutoMode)
				jumpUtils.jumpTo(getResources().getString(R.string.title_activity_mp3), MP3Activity.this,
						XmlUtils.activityClasses.get(0), true);
		...
		case R.id.button_fail:
			...
			if (FunctionApplication.isAutoMode)
				jumpUtils.jumpTo(getResources().getString(R.string.title_activity_mp3), MP3Activity.this,
						XmlUtils.activityClasses.get(0), false);
			MP3Activity.this.finish();
			break;
		}
	}
	...
	public boolean findMusic(String mnt, String type) {
		...
		try {
			...
			for (int i = 0; i < fl.length; i++) {
				if (fl[i].isDirectory())
					findMusic(fl[i].getAbsolutePath(), type);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			new AlertDialog.Builder(MP3Activity.this).setTitle(R.string.title_tips)
					.setMessage(R.string.message_resultNG)
					.setPositiveButton("NG", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
							...
							if (FunctionApplication.isAutoMode)
								jumpUtils.jumpTo(getResources().getString(R.string.title_activity_mp4),
										MP3Activity.this, XmlUtils.activityClasses.get(0), false);
							MP3Activity.this.finish();
						}
					}).show();
			return true;
	...
	private BroadcastReceiver headSetReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getIntExtra("state", 2) == 0) {
				...
				tv_mp3.setText(getResources().getString(R.string.label_mp3_detected)
						+ getHeadsetType(intent.getIntExtra("microphone", 2)));
	...
	private String getHeadsetType(int type) {
		if (type == 1)
			...
			return getResources().getString(R.string.label_mp3_headset_type_3);
	}
