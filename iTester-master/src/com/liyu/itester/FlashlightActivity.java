	...
	protected void onStart() {
		...
		public void onClick(View v) {
			...
			case R.id.button_pass:
				...
				this.setResult(R.id.button_flashlight,intent);
				 if(FunctionApplication.isAutoMode)
					jumpUtils.jumpTo(getResources().getString(R.string.title_activity_flashlight), FlashlightActivity.this, XmlUtils.activityClasses.get(0), true);
				finish();
				break;
			case R.id.button_fail:
				...
				this.setResult(R.id.button_flashlight,intent);
				//if(FunctionApplication.isAutoMode)
					jumpUtils.jumpTo(getResources().getString(R.string.title_activity_flashlight), FlashlightActivity.this, XmlUtils.activityClasses.get(0), false);
				this.finish();
				break;
			}
		}
